...
using InvalidVersionInfoException = _PDF417BCode.QRCode.ExceptionHandler.InvalidVersionInfoException;
...
namespace _PDF417BCode.QRCode.Codec.Reader.Pattern
{
	...
	public class FinderPattern
	{
		...
		internal static Line[] findLineAcross(bool[][] image)
		{
            ...
            canvas.drawLines(foundLines, _PDF417BCode.QRCode.Codec.Util.Color_Fields.LIGHTGREEN);
			return foundLines;
		}
		...
		internal static Point[] getCenter(Line[] crossLines)
		{
			...
			{
                canvas.drawPolygon(foundPoints, _PDF417BCode.QRCode.Codec.Util.Color_Fields.RED);
				return foundPoints;
			}
			else
		...
		internal static int calcExactVersion(Point[] centers, int[] angle, int[] moduleSize, bool[][] image)
		{
            ...
            canvas.drawPoints(points, _PDF417BCode.QRCode.Codec.Util.Color_Fields.RED);
