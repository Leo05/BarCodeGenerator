...
using _PDF417BCode.QRCode.Codec.Data;
using AlignmentPatternNotFoundException = _PDF417BCode.QRCode.ExceptionHandler.AlignmentPatternNotFoundException;
using FinderPatternNotFoundException = _PDF417BCode.QRCode.ExceptionHandler.FinderPatternNotFoundException;
using SymbolNotFoundException = _PDF417BCode.QRCode.ExceptionHandler.SymbolNotFoundException;
using InvalidVersionException = _PDF417BCode.QRCode.ExceptionHandler.InvalidVersionException;
using VersionInformationException = _PDF417BCode.QRCode.ExceptionHandler.VersionInformationException;
using _PDF417BCode.QRCode.Geom;
using _PDF417BCode.QRCode.Codec.Reader.Pattern;
using _PDF417BCode.QRCode.Codec.Util;
using SystemUtils = _PDF417BCode.QRCode.Codec.Util.SystemUtils;

namespace _PDF417BCode.QRCode.Codec.Reader
{
	...
	public class QRCodeImageReader
	{
		...
		internal virtual bool[][] getQRCodeMatrix(bool[][] image, SamplingGrid gridLines)
		{
            ...
            canvas.drawPoint(bottomRightPoint, _PDF417BCode.QRCode.Codec.Util.Color_Fields.BLUE);
