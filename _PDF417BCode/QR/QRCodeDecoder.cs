...
using QRCodeImage = _PDF417BCode.QRCode.Codec.Data.QRCodeImage;
using QRCodeSymbol = _PDF417BCode.QRCode.Codec.Data.QRCodeSymbol;
using ReedSolomon = _PDF417BCode.QRCode.Codec.Ecc.ReedSolomon;
using DecodingFailedException = _PDF417BCode.QRCode.ExceptionHandler.DecodingFailedException;
using InvalidDataBlockException = _PDF417BCode.QRCode.ExceptionHandler.InvalidDataBlockException;
...
using QRCodeDataBlockReader = _PDF417BCode.QRCode.Codec.Reader.QRCodeDataBlockReader;
using QRCodeImageReader = _PDF417BCode.QRCode.Codec.Reader.QRCodeImageReader;
using DebugCanvas = _PDF417BCode.QRCode.Codec.Util.DebugCanvas;
using DebugCanvasAdapter = _PDF417BCode.QRCode.Codec.Util.DebugCanvasAdapter;
using QRCodeUtility = _PDF417BCode.QRCode.Codec.Util.QRCodeUtility;

namespace _PDF417BCode.QRCode.Codec
{
